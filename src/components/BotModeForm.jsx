...
import { getWhatsAppConfig } from '../utils/localStorage';

export default function BotModeForm({ onSubmit }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="glass-card p-8 sm:p-10 rounded-3xl border border-white/10 text-left space-y-6 shadow-2xl fade-in">
